...
public class SpecApiLangGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ApiElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cBaseUrlURLTerminalRuleCall_2_0 = (RuleCall)cBaseUrlAssignment_2.eContents().get(0);
		private final Keyword cLeftCurlyBracketKeyword_3 = (Keyword)cGroup.eContents().get(3);
		private final Assignment cBlocksAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final RuleCall cBlocksServiceBlockParserRuleCall_4_0 = (RuleCall)cBlocksAssignment_4.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_5 = (Keyword)cGroup.eContents().get(5);
		
		//Api:
		//	"api" name=ID baseUrl=URL? "{" blocks+=ServiceBlock* "}";
		public ParserRule getRule() { return rule; }
		...
		//URL
		public RuleCall getBaseUrlURLTerminalRuleCall_2_0() { return cBaseUrlURLTerminalRuleCall_2_0; }
		...
		//ServiceBlock
		public RuleCall getBlocksServiceBlockParserRuleCall_4_0() { return cBlocksServiceBlockParserRuleCall_4_0; }
	...
	public class ResponseBlockElements extends AbstractParserRuleElementFinder {
		...
		//ResponseBlock:
		//	{ResponseBlock} "response" code=INTEGER? message=STRING? type=BlockType?;
		public ParserRule getRule() { return rule; }
	...
	public class TypeElements extends AbstractParserRuleElementFinder {
		...
		//Type:
		//	UserType | IntrinsicType | / * | DictionaryType * / ArrayType;
		public ParserRule getRule() { return rule; }
	...
	@Inject
	public SpecApiLangGrammarAccess(GrammarProvider grammarProvider) {
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.specapi.SpecApiLang".equals(grammar.getName())) {
				return grammar;
			}
