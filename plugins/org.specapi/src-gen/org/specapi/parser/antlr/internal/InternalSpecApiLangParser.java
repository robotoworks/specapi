...
public class InternalSpecApiLangParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_URL", "RULE_STRING", "RULE_NUMBER", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'package'", "'api'", "'{'", "'}'", "'headers'", "','", "'/'", "'-'", "'params'", "'body'", "'response'", "'mixin'", "':'", "'='", "'[]'", "'entity'", "'enum'", "'extends'", "'string'", "'boolean'", "'int'", "'long'", "'double'", "'.'", "'get'", "'put'", "'post'", "'delete'", "'patch'", "'true'", "'false'"
    };
    ...
    public final EObject ruleSpecApiDocument() throws RecognitionException {
        ...
        try {
            ...
            {
            otherlv_0=(Token)match(input,12,FOLLOW_12_in_ruleSpecApiDocument122); 
    ...
    public final EObject ruleApi() throws RecognitionException {
        ...
        try {
            ...
            {
            otherlv_0=(Token)match(input,13,FOLLOW_13_in_ruleApi367); 
            ...
            otherlv_3=(Token)match(input,14,FOLLOW_14_in_ruleApi424); 
            ...
            do {
                ...
                if ( (LA4_0==16||LA4_0==20||(LA4_0>=36 && LA4_0<=40)) ) {
                    alt4=1;
                }
            ...
            otherlv_5=(Token)match(input,15,FOLLOW_15_in_ruleApi458); 
    ...
    public final EObject ruleHeaderBlock() throws RecognitionException {
        ...
        try {
            ...
            otherlv_1=(Token)match(input,16,FOLLOW_16_in_ruleHeaderBlock696); 
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    otherlv_3=(Token)match(input,17,FOLLOW_17_in_ruleHeaderBlock730); 
    ...
    public final EObject ruleHttpMethod() throws RecognitionException {
        ...
        try {
            ...
            otherlv_3=(Token)match(input,14,FOLLOW_14_in_ruleHttpMethod901); 
            ...
            otherlv_5=(Token)match(input,15,FOLLOW_15_in_ruleHttpMethod935); 
    ...
    public final EObject rulePath() throws RecognitionException {
        ...
        try {
            ...
            otherlv_1=(Token)match(input,18,FOLLOW_18_in_rulePath1200); 
            ...
            if ( (LA10_0==RULE_ID) ) {
                ...
                else if ( (LA10_1==EOF||LA10_1==14||(LA10_1>=18 && LA10_1<=19)||LA10_1==35) ) {
                    alt10=1;
                }
                else {
                    NoViableAltException nvae =
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    otherlv_4=(Token)match(input,18,FOLLOW_18_in_rulePath1257); 
            	    ...
            	    if ( (LA11_0==RULE_ID) ) {
            	        ...
            	        else if ( (LA11_1==EOF||LA11_1==14||(LA11_1>=18 && LA11_1<=19)||LA11_1==35) ) {
            	            alt11=1;
            	        }
            	        else {
            	            NoViableAltException nvae =
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    kw=(Token)match(input,19,FOLLOW_19_in_ruleArbitraryPathSegment1417); 
    ...
    public final EObject ruleParamsBlock() throws RecognitionException {
        ...
        try {
            ...
            otherlv_1=(Token)match(input,20,FOLLOW_20_in_ruleParamsBlock1542); 
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    otherlv_3=(Token)match(input,17,FOLLOW_17_in_ruleParamsBlock1576); 
    ...
    public final EObject ruleBodyBlock() throws RecognitionException {
        ...
        try {
            ...
            {
            otherlv_0=(Token)match(input,21,FOLLOW_21_in_ruleBodyBlock1862); 
    ...
    // ../org.specapi/src-gen/org/specapi/parser/antlr/internal/InternalSpecApiLang.g:894:1: ruleResponseBlock returns [EObject current=null] : ( () otherlv_1= 'response' (otherlv_2= 'mixin' ( (otherlv_3= RULE_ID ) ) )? ( (lv_type_4_0= ruleBlockType ) )? ) ;
    public final EObject ruleResponseBlock() throws RecognitionException {
        ...
        try {
            // ../org.specapi/src-gen/org/specapi/parser/antlr/internal/InternalSpecApiLang.g:897:28: ( ( () otherlv_1= 'response' (otherlv_2= 'mixin' ( (otherlv_3= RULE_ID ) ) )? ( (lv_type_4_0= ruleBlockType ) )? ) )
            // ../org.specapi/src-gen/org/specapi/parser/antlr/internal/InternalSpecApiLang.g:898:1: ( () otherlv_1= 'response' (otherlv_2= 'mixin' ( (otherlv_3= RULE_ID ) ) )? ( (lv_type_4_0= ruleBlockType ) )? )
            {
            // ../org.specapi/src-gen/org/specapi/parser/antlr/internal/InternalSpecApiLang.g:898:1: ( () otherlv_1= 'response' (otherlv_2= 'mixin' ( (otherlv_3= RULE_ID ) ) )? ( (lv_type_4_0= ruleBlockType ) )? )
            // ../org.specapi/src-gen/org/specapi/parser/antlr/internal/InternalSpecApiLang.g:898:2: () otherlv_1= 'response' (otherlv_2= 'mixin' ( (otherlv_3= RULE_ID ) ) )? ( (lv_type_4_0= ruleBlockType ) )?
            {
            ...
            otherlv_1=(Token)match(input,22,FOLLOW_22_in_ruleResponseBlock1975); 

                	newLeafNode(otherlv_1, grammarAccess.getResponseBlockAccess().getResponseKeyword_1());
                
            // ../org.specapi/src-gen/org/specapi/parser/antlr/internal/InternalSpecApiLang.g:908:1: (otherlv_2= 'mixin' ( (otherlv_3= RULE_ID ) ) )?
            int alt16=2;
            ...
            switch (alt16) {
                case 1 :
                    // ../org.specapi/src-gen/org/specapi/parser/antlr/internal/InternalSpecApiLang.g:908:3: otherlv_2= 'mixin' ( (otherlv_3= RULE_ID ) )
                    {
                    otherlv_2=(Token)match(input,23,FOLLOW_23_in_ruleResponseBlock1988); 
            ...
            if ( (LA17_0==RULE_ID||LA17_0==14||(LA17_0>=30 && LA17_0<=34)) ) {
                alt17=1;
            }
            switch (alt17) {
                case 1 :
    ...
    public final EObject ruleBlockType() throws RecognitionException {
        ...
        try {
            ...
            if ( (LA18_0==RULE_ID||(LA18_0>=30 && LA18_0<=34)) ) {
                alt18=1;
            }
            else if ( (LA18_0==14) ) {
                alt18=2;
    ...
    public final EObject ruleMember() throws RecognitionException {
        ...
        try {
            ...
            otherlv_1=(Token)match(input,24,FOLLOW_24_in_ruleMember2281); 
            ...
            switch (alt20) {
                case 1 :
                    ...
                    {
                    otherlv_3=(Token)match(input,25,FOLLOW_25_in_ruleMember2315); 
    ...
    public final EObject ruleArrayType() throws RecognitionException {
        ...
        try {
            ...
            {
            lv_id_1_0=(Token)match(input,26,FOLLOW_26_in_ruleArrayType2618); 
    ...
    public final EObject ruleComplexTypeDeclaration() throws RecognitionException {
        ...
        try {
            ...
            {
            lv_keyword_0_0=(Token)match(input,27,FOLLOW_27_in_ruleComplexTypeDeclaration2928); 
    ...
    public final EObject ruleEnumTypeDeclaration() throws RecognitionException {
        ...
        try {
            ...
            {
            lv_keyword_0_0=(Token)match(input,28,FOLLOW_28_in_ruleEnumTypeDeclaration3074); 
            ...
            switch (alt25) {
                case 1 :
                    ...
                    {
                    otherlv_2=(Token)match(input,29,FOLLOW_29_in_ruleEnumTypeDeclaration3122); 
    ...
    public final EObject ruleEnumTypeLiteral() throws RecognitionException {
        ...
        try {
            ...
            {
            otherlv_0=(Token)match(input,14,FOLLOW_14_in_ruleEnumTypeLiteral3250); 
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    otherlv_2=(Token)match(input,17,FOLLOW_17_in_ruleEnumTypeLiteral3284); 
            ...
            otherlv_4=(Token)match(input,15,FOLLOW_15_in_ruleEnumTypeLiteral3319); 
        ...
        try {
            ...
            switch (alt28) {
                case 1 :
                    ...
                    {
                    lv_assignment_1_0=(Token)match(input,25,FOLLOW_25_in_ruleEnumMember3431); 
    ...
    public final EObject ruleComplexTypeLiteral() throws RecognitionException {
        ...
        try {
            ...
            {
            otherlv_0=(Token)match(input,14,FOLLOW_14_in_ruleComplexTypeLiteral3551); 
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    otherlv_2=(Token)match(input,17,FOLLOW_17_in_ruleComplexTypeLiteral3585); 
            ...
            otherlv_4=(Token)match(input,15,FOLLOW_15_in_ruleComplexTypeLiteral3620); 
    ...
    public final EObject ruleStringType() throws RecognitionException {
        ...
        try {
            ...
            {
            lv_id_0_0=(Token)match(input,30,FOLLOW_30_in_ruleStringType3854); 
    ...
    public final EObject ruleBooleanType() throws RecognitionException {
        ...
        try {
            ...
            {
            lv_id_0_0=(Token)match(input,31,FOLLOW_31_in_ruleBooleanType3954); 
    ...
    public final EObject ruleIntegerType() throws RecognitionException {
        ...
        try {
            ...
            {
            lv_id_0_0=(Token)match(input,32,FOLLOW_32_in_ruleIntegerType4200); 
    ...
    public final EObject ruleLongType() throws RecognitionException {
        ...
        try {
            ...
            {
            lv_id_0_0=(Token)match(input,33,FOLLOW_33_in_ruleLongType4300); 
    ...
    public final EObject ruleDoubleType() throws RecognitionException {
        ...
        try {
            ...
            {
            lv_id_0_0=(Token)match(input,34,FOLLOW_34_in_ruleDoubleType4400); 
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    kw=(Token)match(input,35,FOLLOW_35_in_ruleQualifiedName4519); 
        ...
        try {
            ...
            switch (alt33) {
                case 1 :
                    ...
                    {
                    kw=(Token)match(input,19,FOLLOW_19_in_ruleSignedNumber4632); 
        ...
        try {
            ...
            switch (alt34) {
                case 1 :
                    ...
                    {
                    enumLiteral_0=(Token)match(input,36,FOLLOW_36_in_ruleHttpMethodType4708); 
                ...
                case 2 :
                    ...
                    {
                    enumLiteral_1=(Token)match(input,37,FOLLOW_37_in_ruleHttpMethodType4725); 
                ...
                case 3 :
                    ...
                    {
                    enumLiteral_2=(Token)match(input,38,FOLLOW_38_in_ruleHttpMethodType4742); 
                ...
                case 4 :
                    ...
                    {
                    enumLiteral_3=(Token)match(input,39,FOLLOW_39_in_ruleHttpMethodType4759); 
                ...
                case 5 :
                    ...
                    {
                    enumLiteral_4=(Token)match(input,40,FOLLOW_40_in_ruleHttpMethodType4776); 
        ...
        try {
            ...
            switch (alt35) {
                case 1 :
                    ...
                    {
                    enumLiteral_0=(Token)match(input,41,FOLLOW_41_in_ruleBooleanValue4821); 
                ...
                case 2 :
                    ...
                    {
                    enumLiteral_1=(Token)match(input,42,FOLLOW_42_in_ruleBooleanValue4838); 
    ...
    static final String[] DFA21_transitionS = {
            ...
            "\5\7\1\uffff\3\7\2\uffff\1\7\1\10\11\uffff\5\7",
            "\5\11\1\uffff\3\11\2\uffff\1\11\1\10\11\uffff\5\11",
            "\5\11\1\uffff\3\11\2\uffff\1\11\1\10\11\uffff\5\11",
            "\5\11\1\uffff\3\11\2\uffff\1\11\1\10\11\uffff\5\11",
            "\5\11\1\uffff\3\11\2\uffff\1\11\1\10\11\uffff\5\11",
            "\5\11\1\uffff\3\11\2\uffff\1\11\1\10\11\uffff\5\11",
    ...
    public static final BitSet FOLLOW_12_in_ruleSpecApiDocument122 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_ruleQualifiedName_in_ruleSpecApiDocument143 = new BitSet(new long[]{0x0000000018002002L});
    public static final BitSet FOLLOW_ruleDeclaration_in_ruleSpecApiDocument164 = new BitSet(new long[]{0x0000000018002002L});
    ...
    public static final BitSet FOLLOW_13_in_ruleApi367 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleApi384 = new BitSet(new long[]{0x0000000000004020L});
    public static final BitSet FOLLOW_RULE_URL_in_ruleApi406 = new BitSet(new long[]{0x0000000000004000L});
    public static final BitSet FOLLOW_14_in_ruleApi424 = new BitSet(new long[]{0x000001F000118000L});
    public static final BitSet FOLLOW_ruleServiceBlock_in_ruleApi445 = new BitSet(new long[]{0x000001F000118000L});
    public static final BitSet FOLLOW_15_in_ruleApi458 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_16_in_ruleHeaderBlock696 = new BitSet(new long[]{0x0000000000000050L});
    public static final BitSet FOLLOW_ruleMember_in_ruleHeaderBlock717 = new BitSet(new long[]{0x0000000000020002L});
    public static final BitSet FOLLOW_17_in_ruleHeaderBlock730 = new BitSet(new long[]{0x0000000000000050L});
    public static final BitSet FOLLOW_ruleMember_in_ruleHeaderBlock751 = new BitSet(new long[]{0x0000000000020002L});
    ...
    public static final BitSet FOLLOW_RULE_ID_in_ruleHttpMethod862 = new BitSet(new long[]{0x0000000000044000L});
    public static final BitSet FOLLOW_rulePath_in_ruleHttpMethod888 = new BitSet(new long[]{0x0000000000004000L});
    public static final BitSet FOLLOW_14_in_ruleHttpMethod901 = new BitSet(new long[]{0x0000000000718000L});
    public static final BitSet FOLLOW_ruleHttpMethodBlock_in_ruleHttpMethod922 = new BitSet(new long[]{0x0000000000718000L});
    public static final BitSet FOLLOW_15_in_ruleHttpMethod935 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_18_in_rulePath1200 = new BitSet(new long[]{0x0000000000000050L});
    public static final BitSet FOLLOW_ruleArbitraryPathSegment_in_rulePath1217 = new BitSet(new long[]{0x0000000000040002L});
    public static final BitSet FOLLOW_ruleMember_in_rulePath1243 = new BitSet(new long[]{0x0000000000040002L});
    public static final BitSet FOLLOW_18_in_rulePath1257 = new BitSet(new long[]{0x0000000000000050L});
    public static final BitSet FOLLOW_ruleArbitraryPathSegment_in_rulePath1274 = new BitSet(new long[]{0x0000000000040002L});
    public static final BitSet FOLLOW_ruleMember_in_rulePath1300 = new BitSet(new long[]{0x0000000000040002L});
    ...
    public static final BitSet FOLLOW_ruleQualifiedName_in_ruleArbitraryPathSegment1398 = new BitSet(new long[]{0x0000000000080002L});
    public static final BitSet FOLLOW_19_in_ruleArbitraryPathSegment1417 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_ruleQualifiedName_in_ruleArbitraryPathSegment1439 = new BitSet(new long[]{0x0000000000080002L});
    ...
    public static final BitSet FOLLOW_20_in_ruleParamsBlock1542 = new BitSet(new long[]{0x0000000000000050L});
    public static final BitSet FOLLOW_ruleMember_in_ruleParamsBlock1563 = new BitSet(new long[]{0x0000000000020002L});
    public static final BitSet FOLLOW_17_in_ruleParamsBlock1576 = new BitSet(new long[]{0x0000000000000050L});
    public static final BitSet FOLLOW_ruleMember_in_ruleParamsBlock1597 = new BitSet(new long[]{0x0000000000020002L});
    ...
    public static final BitSet FOLLOW_21_in_ruleBodyBlock1862 = new BitSet(new long[]{0x00000007C0004010L});
    ...
    public static final BitSet FOLLOW_22_in_ruleResponseBlock1975 = new BitSet(new long[]{0x00000007C0804012L});
    public static final BitSet FOLLOW_23_in_ruleResponseBlock1988 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleResponseBlock2008 = new BitSet(new long[]{0x00000007C0004012L});
    ...
    public static final BitSet FOLLOW_RULE_ID_in_ruleMember2241 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_RULE_STRING_in_ruleMember2261 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_24_in_ruleMember2281 = new BitSet(new long[]{0x00000007C0000010L});
    public static final BitSet FOLLOW_ruleType_in_ruleMember2302 = new BitSet(new long[]{0x0000000002000002L});
    public static final BitSet FOLLOW_25_in_ruleMember2315 = new BitSet(new long[]{0x00000600000800C0L});
    ...
    public static final BitSet FOLLOW_ruleUserType_in_ruleArrayType2578 = new BitSet(new long[]{0x0000000004000000L});
    public static final BitSet FOLLOW_ruleIntrinsicType_in_ruleArrayType2597 = new BitSet(new long[]{0x0000000004000000L});
    public static final BitSet FOLLOW_26_in_ruleArrayType2618 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_27_in_ruleComplexTypeDeclaration2928 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleComplexTypeDeclaration2958 = new BitSet(new long[]{0x00000007C0004012L});
    ...
    public static final BitSet FOLLOW_28_in_ruleEnumTypeDeclaration3074 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleEnumTypeDeclaration3104 = new BitSet(new long[]{0x0000000020004002L});
    public static final BitSet FOLLOW_29_in_ruleEnumTypeDeclaration3122 = new BitSet(new long[]{0x0000000100000000L});
    public static final BitSet FOLLOW_ruleIntegerType_in_ruleEnumTypeDeclaration3143 = new BitSet(new long[]{0x0000000000004002L});
    ...
    public static final BitSet FOLLOW_14_in_ruleEnumTypeLiteral3250 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_ruleEnumMember_in_ruleEnumTypeLiteral3271 = new BitSet(new long[]{0x0000000000028000L});
    public static final BitSet FOLLOW_17_in_ruleEnumTypeLiteral3284 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_ruleEnumMember_in_ruleEnumTypeLiteral3305 = new BitSet(new long[]{0x0000000000028000L});
    public static final BitSet FOLLOW_15_in_ruleEnumTypeLiteral3319 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_RULE_ID_in_ruleEnumMember3407 = new BitSet(new long[]{0x0000000002000002L});
    public static final BitSet FOLLOW_25_in_ruleEnumMember3431 = new BitSet(new long[]{0x0000000000000080L});
    ...
    public static final BitSet FOLLOW_14_in_ruleComplexTypeLiteral3551 = new BitSet(new long[]{0x0000000000000050L});
    public static final BitSet FOLLOW_ruleMember_in_ruleComplexTypeLiteral3572 = new BitSet(new long[]{0x0000000000028000L});
    public static final BitSet FOLLOW_17_in_ruleComplexTypeLiteral3585 = new BitSet(new long[]{0x0000000000000050L});
    public static final BitSet FOLLOW_ruleMember_in_ruleComplexTypeLiteral3606 = new BitSet(new long[]{0x0000000000028000L});
    public static final BitSet FOLLOW_15_in_ruleComplexTypeLiteral3620 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_30_in_ruleStringType3854 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_31_in_ruleBooleanType3954 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_32_in_ruleIntegerType4200 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_33_in_ruleLongType4300 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_34_in_ruleDoubleType4400 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_RULE_ID_in_ruleQualifiedName4500 = new BitSet(new long[]{0x0000000800000002L});
    public static final BitSet FOLLOW_35_in_ruleQualifiedName4519 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleQualifiedName4534 = new BitSet(new long[]{0x0000000800000002L});
    ...
    public static final BitSet FOLLOW_19_in_ruleSignedNumber4632 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_RULE_NUMBER_in_ruleSignedNumber4649 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_36_in_ruleHttpMethodType4708 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_37_in_ruleHttpMethodType4725 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_38_in_ruleHttpMethodType4742 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_39_in_ruleHttpMethodType4759 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_40_in_ruleHttpMethodType4776 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_41_in_ruleBooleanValue4821 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_42_in_ruleBooleanValue4838 = new BitSet(new long[]{0x0000000000000002L});
