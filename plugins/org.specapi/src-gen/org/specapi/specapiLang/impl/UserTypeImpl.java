 ...
 * <ul>
 *   <li>{@link org.specapi.specapiLang.impl.UserTypeImpl#getDeclaration <em>Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UserTypeImpl extends TypeImpl implements UserType
{
  ...
  {
    return SpecapiLangPackage.Literals.USER_TYPE;
  }
    ...
    if (declaration != null && declaration.eIsProxy())
    {
      ...
      if (declaration != oldDeclaration)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SpecapiLangPackage.USER_TYPE__DECLARATION, oldDeclaration, declaration));
      }
    }
    return declaration;
  }
  ...
  public void setDeclaration(UserTypeDeclaration newDeclaration)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpecapiLangPackage.USER_TYPE__DECLARATION, oldDeclaration, declaration));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SpecapiLangPackage.USER_TYPE__DECLARATION:
