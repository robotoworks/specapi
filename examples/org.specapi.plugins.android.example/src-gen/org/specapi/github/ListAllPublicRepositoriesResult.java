...
public class ListAllPublicRepositoriesResult extends ServiceResult {
	private List<Repository> repositories;
	public List<Repository> getRepositories(){
		return this.repositories;
	}
	
	public ListAllPublicRepositoriesResult(JsonEntityReaderProvider provider, InputStream inStream) throws IOException {
