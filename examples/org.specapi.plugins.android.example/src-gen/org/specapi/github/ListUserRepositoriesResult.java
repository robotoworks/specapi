...
public class ListUserRepositoriesResult extends ServiceResult {
	private List<Repository> repositories;
	public List<Repository> getRepositories(){
		return this.repositories;
	}
	
	public ListUserRepositoriesResult(JsonEntityReaderProvider provider, InputStream inStream) throws IOException {
