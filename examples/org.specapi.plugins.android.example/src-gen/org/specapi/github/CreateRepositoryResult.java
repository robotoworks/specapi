...
public class CreateRepositoryResult extends ServiceResult {
	private Repository repository;
	public Repository getRepository(){
		return this.repository;
	}
	
	public CreateRepositoryResult(JsonEntityReaderProvider provider, InputStream inStream) throws IOException {
