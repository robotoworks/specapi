...
public class CreateOrganizationRepositoryResult extends ServiceResult {
	private Repository repository;
	public Repository getRepository(){
		return this.repository;
	}
	
	public CreateOrganizationRepositoryResult(JsonEntityReaderProvider provider, InputStream inStream) throws IOException {
