...
public class ListOrganizationRepositoriesResult extends ServiceResult {
	private List<Repository> repositories;
	public List<Repository> getRepositories(){
		return this.repositories;
	}
	
	public ListOrganizationRepositoriesResult(JsonEntityReaderProvider provider, InputStream inStream) throws IOException {
