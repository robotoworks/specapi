...
public class RepositoryOwner {
	...
	public static final String KEY_SITE_ADMIN = "site_admin";
	...
	public ContentValues toContentValues(Map<String, String> map) {
		...
		ContentValuesUtil.putMapped(KEY_TYPE, map, values, type);
		ContentValuesUtil.putMapped(KEY_SITE_ADMIN, map, values, siteAdmin);
